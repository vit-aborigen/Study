...
class Board: ObservableObject {
    ...
    func openCell(cellCoords: (Int, Int)) {
        ...
        if cell.hasBomb && isFirstClick {
            cellDict = [:]
            generateBoard()
            openCell(cellCoords: cellCoords)
            return
        }
    ...
    private func getNeighbours(cell: (Int, Int)) -> [(Int, Int)] {
    ...
    private func openEmptyBlock(cell: (Int, Int)) {
